    ...
    <>
      <div className="fixed bottom-0 left-0 w-full bg-white border-t border-gray-200 shadow-lg z-50 block md:hidden lg:hidden">
        <div className="flex justify-around items-center w-full">
          <Link className="flex flex-col items-center justify-center py-2 px-1 flex-1 text-center" href="/">
          ...
          <Link className="flex flex-col items-center justify-center py-2 px-1 flex-1 text-center" href="/my-account">
            ...
            <span className="text-xs text-gray-600 leading-tight">Profile</span>
          </Link>
          <Link className="flex flex-col items-center justify-center py-2 px-1 flex-1 text-center" href="/products">
            <span className="flex items-center justify-center mb-1">
              <svg
                width="16"
                height="16"
            ...
            <span className="text-xs text-gray-600 leading-tight">Products</span>
          </Link>
          <Link
            className="flex flex-col items-center justify-center py-2 px-1 flex-1 text-center relative"
            href="/cart"
          >
            <span className="flex items-center justify-center mb-1 relative">
              <svg
                width="16"
                height="16"
                viewBox="0 0 22 25"
