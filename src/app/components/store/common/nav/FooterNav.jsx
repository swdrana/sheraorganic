  ...
  return (
    <>
      <div className="mobile-toolbar d-block d-md-none d-lg-none">
        <div className="d-flex justify-content-around table-layout-fixed w-100">
          <a
            className="d-table-cell mobile-toolbar-item mobile-menu-toggle"
            type="button"
          ...
          >
            ...
            <span className="mobile-toolbar-label">Category</span>
          </a>
          ...
          <Link className="d-table-cell mobile-toolbar-item" href="/my-account">
            <span className="mobile-toolbar-icon">
              <svg
                width="18"
                height="25"
