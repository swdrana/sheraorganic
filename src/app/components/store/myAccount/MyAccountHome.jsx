...
const MyAccountHome = () => {
  ...
  const orderProcessing =
    userOrders?.filter?.((o) => o.status === "Processing") || [];

  const orderDelivered = Array.isArray(userOrders)
    ? userOrders.filter((o) => o.status === "Delivered")
    : [];

  // console.log("user order..", userOrders);
  const orderPending = Array.isArray(userOrders)
    ...
    <>
      <section className="my-account pt-6 pb-120">
        <div className="container">
          <div className="account-info d-flex align-items-center gap-6 p-4 p-sm-6 bg-white rounded mb-4 flex-wrap flex-lg-nowrap">
            <div className="profile-pic bg-shade rounded">
              {user?.img ? (
                <img
                  src={user?.img}
                  alt="avatar"
                ...
                <img
                  src="https://res.cloudinary.com/dmadhbgty/image/upload/v1735740878/grostore/cute-boy-smiling-cartoon-kawaii-boy-illustration-boy-avatar-happy-kid_1001605-3447.avif"
                  alt="avatar"
                  className="img-fluid rounded"
                />
              )}
            ...
            <div className="profile-inf-right">
              ...
              <div className="info-meta d-flex align-items-center gap-2 gap-md-4 fs-xs flex-wrap">
                <span>
              ...
              <div className="profile-achievements d-flex align-items-center flex-wrap mt-4">
                <div className="achievement-box d-flex align-items-center gap-3">
                  <span className="icon d-inline-flex align-items-center justify-content-center flex-shrink-0 bg-color-1 rounded-3">
                    <svg
                      width="26"
                      height="32"
                      viewBox="0 0 26 32"
                  ...
                  <div>
                    <h4 className="mb-1">{userOrders?.length}</h4>
                    <span>Total Order</span>
                  </div>
                </div>
                <div className="achievement-box d-flex align-items-center gap-3">
                  <span className="icon bg-color-2 d-inline-flex align-items-center justify-content-center flex-shrink-0 bg-color-1 rounded-3">
                    <svg
                      width="32"
                      height="32"
                      viewBox="0 0 32 32"
                  ...
                  <div>
                    <h4 className="mb-1">{orderProcessing?.length}</h4>
                    <span>Order Processing</span>
                  </div>
                </div>
                <div className="achievement-box d-flex align-items-center gap-3">
                  <span className="icon bg-color-3 d-inline-flex align-items-center justify-content-center flex-shrink-0 bg-color-1 rounded-3">
                    <svg
                      width="32"
                      height="32"
                      viewBox="0 0 32 32"
                      ...
                      xmlns="http://www.w3.org/2000/svg"
                    >
                      <g clipPath="url(#clip0_1339_6368)">
                        <path
                  ...
                  <div>
                    <h4 className="mb-1">{orderDelivered?.length}</h4>
                    <span>Total Delivered</span>
                  </div>
                </div>
                <div className="achievement-box d-flex align-items-center gap-3">
                  <span className="icon bg-color-4 d-inline-flex align-items-center justify-content-center flex-shrink-0 bg-color-1 rounded-3">
                    <svg
                      width="32"
                      height="32"
                      viewBox="0 0 32 32"
                  ...
                  <div>
                    <h4 className="mb-1">{orderPending?.length}</h4>
