...
const CouponDrawer = () => {
  const { isOpenCouponDrawer, setIsOpenCouponDrawer, couponDetails } =
    useMainContext();
  const {
    handelCouponAdd,
    handelCouponUpdate,
                ...
                >
                  <form
                    onSubmit={handleSubmit(
                      !couponDetails._id ? handelCouponAdd : handelCouponUpdate
                    )}
