...
import VarianTagInput from "../attributes/VariantTagInput";
...
const AttributesDrawer = () => {
  ...
  return (
    <Transition.Root show={isOpenAttributeDrawer} as={Fragment}>
      <Dialog
        as="div"
        className="relative z-[100]"
        onClose={setIsOpenAttributeDrawer}
      >
        <Transition.Child
          as={Fragment}
            ...
            <div className="pointer-events-none fixed inset-y-0 right-0 flex max-w-full pl-10">
              ...
              >
                <Dialog.Panel className="pointer-events-auto w-screen max-w-md">
                  <form
                    onSubmit={handleSubmit(handelAttributeAdd)}
                        ...
                        <div className="flex items-start justify-between space-x-3">
                          <div className="space-y-1">
                            <Dialog.Title className="text-base font-semibold leading-6 text-gray-900">
                              {attributeDetails?.name
                                ? `Update product (${attributeDetails?.name})`
                                : "Add Attribute"}
                            </Dialog.Title>
                          </div>
                          <div className="flex h-7 items-center">
                            <button
                              ...
                              onClick={() => setIsOpenAttributeDrawer(false)}
                            >
                      ...
                      <div className="space-y-6 py-6 sm:space-y-0 sm:divide-y sm:divide-gray-200 sm:py-0">
                        ...
                        <div className="space-y-2 px-4 sm:grid sm:grid-cols-3 sm:gap-4 sm:space-y-0 sm:px-6 sm:py-5">
                          ...
                          <div className="sm:col-span-2">
                            <input
                              type="text"
                              // defaultValue={attributeDetails?.category}
                        ...
                        <div className="space-y-2 px-4 sm:grid sm:grid-cols-3 sm:gap-4 sm:space-y-0 sm:px-6 sm:py-5">
                          ...
                          <div className="min-w-[260px] rounded-lg bg-slate-500 bg-opacity-5 border border-gray-400 px-4 py-3 focus:ring-0 outline-none">
                            <select
                            ...
                            >
                              ...
                              <option value="Dropdown">Dropdow</option>
                        ...
                        {/* variants */}
                        <div
                          className={`${attributeDetails?._id ? "hidden" : ""}`}
                        >
                          <div className=" space-y-2 px-4 sm:grid sm:grid-cols-3 sm:gap-4 sm:space-y-0 sm:px-6 sm:py-5">
                            <div>
                              <label className="block text-sm font-medium leading-6 text-gray-900 sm:mt-1.5">
